    ...
    <div class="page-login">
        ...
        <div class="login-panel">
            <div class="form">
                ...
                <el-input placeholder="手机号/用户名/邮箱" prefix-icon="el-icon-user" v-model='userName'></el-input>
                <el-input placeholder="密码" prefix-icon="el-icon-lock" v-model='password' type='password'></el-input>
                <div class="foot">
                    <a href="#">忘记密码?</a>
                </div>
