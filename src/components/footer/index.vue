<template>
    <div class="m-footer">
        ...
        <div class="bottom">
            <p><router-link :to="{path:'/'}">©美团网团购 meituan.com 京ICP证070791号京ICP备10211739号电子公告服务规则</router-link></p>
            <p><router-link :to="{path:'/'}">广播电视节目制作经营许可证（京）字第03889号</router-link></p>
            <p class="specile"><router-link :to="{path:'/'}">京公网安备11010502025545号</router-link></p>
        </div>
    </div>
</template>
<script>
